						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									...
									<a href="#" class="tip-bottom"><?php if($info['id'] != ''): ?>编辑<?php else: ?>添加<?php endif; ?>系统消息</a>
								</p>
							</li>
						</ul>
					</div>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><?php if($info['id'] != ''): ?>编辑<?php else: ?>添加<?php endif; ?>系统消息</h5>
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('System/addNotice');?>" name="basic_validate" id="signupForm">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="title" id="title" placeholder="输入消息标题" value="<?php echo ($info['title']); ?>" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<textarea type="text" name="message" id="title" placeholder="输入消息标题" class="form-control" style="height: 169px; width: 526px;"><?php echo ($info['message']); ?></textarea>
								</div>
							</div>	
