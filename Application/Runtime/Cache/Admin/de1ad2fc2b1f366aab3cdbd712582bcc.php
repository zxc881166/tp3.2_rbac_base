						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $val = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($val % 2 );++$val;?><tr class="long-td">
										...
										<td style="text-align: center"><?php echo (stripslashes(htmlspecialchars_decode($vo["message"]))); ?></td>
										<td style="text-align: center"><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
										<td style="text-align: center">
											<a href="<?php echo U('addNotice',array('id'=>$vo['id']));?>" class="btn btn-primary btn-mini"><i class="fa fa-pencil"></i> 编辑</a>&nbsp;&nbsp;
